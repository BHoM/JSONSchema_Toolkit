...
namespace BH.oM.JsonSchema
{
    public class ConvertConfig : IObject
    {
        ...
        [Description("Bool indicating if types used by the parent type should be linked to as ref, or fully expanded.\n" +
                     ...
                     "For types with abstract or interface properties, this will get even more extreme as all option will be populated. Generally only consider setting this to false for types with few levels of nested proeprty types, and generally no interface types on properties.")]
